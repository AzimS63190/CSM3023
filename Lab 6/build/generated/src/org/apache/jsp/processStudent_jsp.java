...
public final class processStudent_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("\n");
      lab6.com.Student myStudent = null;
      synchronized (request) {
        myStudent = (lab6.com.Student) _jspx_page_context.getAttribute("myStudent", PageContext.REQUEST_SCOPE);
        if (myStudent == null){
          myStudent = new lab6.com.Student();
